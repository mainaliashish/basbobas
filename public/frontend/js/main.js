(function ($) {
    "use strict";
  // var image_url = window.location.origin;
  // image = image_url + '/img/logo.png';
  // document.getElementById("nav#dropdown").src = image;
  ...
  ***************************************/
  $("nav#dropdown").meanmenu({
      siteLogo:
          '<a href="#" id="mobile-logo" class="mobile-logo"><img id="company_logo_mobile" src="" alt="Basobas Develpoer"  width="100" height="135"/></a>',
  });
